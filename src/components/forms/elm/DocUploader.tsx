...
const DocUploader: React.FC<UploadDocFromProps> = ({ onChange, selected, emptyPreview, active, label, message }) => {
            ...
            <div className="mt-2 sm:col-span-2 sm:mt-0">
                <div className="flex w-full justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div className="text-center">
                        ...
                        <p className="text-xs leading-5 text-gray-600">Docs, PDF, XLSX up to 10MB</p>
