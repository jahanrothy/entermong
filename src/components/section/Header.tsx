...
const HeaderPanel: React.FC<HeaderProps> = ({ MobileMenu }) => {
  ...
  return (
    <div className="mx-4 sticky top-0 z-40 flex h-20 shrink-0 items-center gap-x-4 rounded-b-2xl bg-white px-6 py-5 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
        ...
        <div className={"flex items-center justify-between w-auto flex-auto"}>
          ...
          <div className="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" className="relative">
              ...
              >
                <MenuItems className="absolute w-[188px] right-0 border-[0.5px] border-gray-100 z-10 mt-2.5 origin-top-right rounded-2xl bg-white py-5 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                      ...
                      {({ focus }) => (
                        <Link
                          ...
                          className={classNames(
                            focus ? "bg-gray-50" : "",
                            "flex items-center px-5 py-2 text-sm leading-6 text-gray-900 hover:bg-pink-50 hover:text-pinkPrimary hover:font-medium"
                          )}
                        >
